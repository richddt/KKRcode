...
PatternList songPatterns = { rainbowWithGlitter, kissingsnakes, snake, rainbow, blinky2, rainbowWithGlitter, confetti, sinelon, juggle, bpm, sinelon, confetti, rainbow, juggle, juggle, bpm, snake, sinelon, rainbowWithGlitter, kissingsnakes, bpm }; //all patterns
